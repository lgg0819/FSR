...
def main():
	...
	hreal_j1_mass = TH1F("hreal_j1_mass","Real J1 Mass Distribution", 20,0,200)
        ...
        hreal_j2_pt   = TH1F("hreal_j2_pt","Real J2 Pt Distribution", 20,0,400)
        ...
        hreal_l1_pt   = TH1F("hreal_l1_pt","Real L1 Pt Distribution", 20,0,400)
        ...
        hreal_l2_pt   = TH1F("hreal_l2_pt","Real L2 Pt Distribution", 20,0,400)
        ...
        hreal_h1_mass = TH1F("hreal_h1_mass","Real H1 Mass Distribution", 20,0,800)
        ...
        hreal_h2_mass = TH1F("hreal_h2_mass","Real H2 Mass Distribution", 20,0,800)
        ...
        hreal_hh_pt   = TH1F("hreal_hh_pt","Real HH Pt Distribution", 20,0,600)
	...
	hsig_j1_mass = TH1F("hsig_j1_mass","Signal J1 Mass Distribution", 20,0,200)
        ...
        hsig_j2_pt   = TH1F("hsig_j2_pt","Signal J2 Pt Distribution", 20,0,400)
	...
	hsig_l1_mass = TH1F("hsig_l1_mass","Signal L1 Mass Distribution", 20,0,200)
        hsig_l1_pt   = TH1F("hsig_l1_pt","Signal L1 Pt Distribution", 20,0,400)
        ...
        hsig_l2_pt   = TH1F("hsig_l2_pt","Signal L2 Pt Distribution", 20,0,400)
	...
	hsig_h1_mass = TH1F("hsig_h1_mass","Signal H1 Mass Distribution", 20,0,800)
	...
	hsig_h2_mass = TH1F("hsig_h2_mass","Signal H2 Mass Distribution", 20,0,800)
	...
	hsig_hh_mass = TH1F("hsig_hh_mass","Signal HH Mass Distribution", 20,0,800)
        hsig_hh_pt   = TH1F("hsig_hh_pt","Signal HH Pt Distribution", 20,0,600)
	...
	htt_j1_mass = TH1F("htt_j1_mass","TTbar J1 Mass Distribution", 20,0,200)
        htt_j1_pt   = TH1F("htt_j1_pt","TTbar J1 Pt Distribution", 20,0,400)
        ...
        htt_j2_pt   = TH1F("htt_j2_pt","TTbar J2 Pt Distribution", 20,0,400)
        ...
        htt_l1_pt   = TH1F("htt_l1_pt","TTbar L1 Pt Distribution", 20,0,400)
        ...
        htt_l2_pt   = TH1F("htt_l2_pt","TTbar L2 Pt Distribution", 20,0,400)
	...
	htt_h1_mass = TH1F("htt_h1_mass","TTbar H1 Mass Distribution", 20,0,800)
	...
	htt_h2_mass = TH1F("htt_h2_mass","TTbar H2 Mass Distribution", 20,0,800)
	...
	htt_hh_mass  = TH1F("htt_hh_mass","TTbar HH Mass Distribution", 20,0,800)
        htt_hh_pt    = TH1F("htt_hh_pt","TTbar HH Pt Distribution", 20,0,600)
	...
	hdy_j1_mass = TH1F("hdy_j1_mass","DY J1 Mass Distribution", 20,0,200)
        hdy_j1_pt   = TH1F("hdy_j1_pt","DY J1 Pt Distribution", 20,0,400)
        ...
        hdy_j2_pt   = TH1F("hdy_j2_pt","DY J2 Pt Distribution", 20,0,400)
        ...
        hdy_l1_pt   = TH1F("hdy_l1_pt","DY L1 Pt Distribution", 20,0,400)
        ...
        hdy_l2_pt   = TH1F("hdy_l2_pt","DY L2 Pt Distribution", 20,0,400)
	...
	hdy_h1_mass = TH1F("hdy_h1_mass","DY H1 Mass Distribution", 20,0,800)
	...
	hdy_h2_mass = TH1F("hdy_h2_mass","DY H2 Mass Distribution", 20,0,800)
	...
	hdy_hh_pt    = TH1F("hdy_hh_pt","DY HH Pt Distribution", 20,0,600)
	...
	hwj_j1_mass = TH1F("hwj_j1_mass","WJ J1 Mass Distribution", 20,0,200)
        hwj_j1_pt   = TH1F("hwj_j1_pt","WJ J1 Pt Distribution", 20,0,400)
        ...
        hwj_j2_pt   = TH1F("hwj_j2_pt","WJ J2 Pt Distribution", 20,0,400)
        ...
        hwj_l1_pt   = TH1F("hwj_l1_pt","WJ L1 Pt Distribution", 20,0,400)
        ...
        hwj_l2_pt   = TH1F("hwj_l2_pt","WJ L2 Pt Distribution", 20,0,400)
        ...
        hwj_h1_mass = TH1F("hwj_h1_mass","WJ H1 Mass Distribution", 20,0,800)
        ...
        hwj_h2_mass = TH1F("hwj_h2_mass","WJ H2 Mass Distribution", 20,0,800)
        ...
        hwj_hh_pt   = TH1F("hwj_hh_pt","WJ HH Pt Distribution", 20,0,600)
	...
	hst_j1_mass = TH1F("hst_j1_mass","ST J1 Mass Distribution", 20,0,200)
        hst_j1_pt   = TH1F("hst_j1_pt","ST J1 Pt Distribution", 20,0,400)
        ...
        hst_j2_pt   = TH1F("hst_j2_pt","ST J2 Pt Distribution", 20,0,400)
        ...
        hst_l1_pt   = TH1F("hst_l1_pt","ST L1 Pt Distribution", 20,0,400)
        ...
        hst_l2_pt   = TH1F("hst_l2_pt","ST L2 Pt Distribution", 20,0,400)
	...
	hst_h1_mass = TH1F("hst_h1_mass","ST H1 Mass Distribution", 20,0,800)
	...
	hst_h2_mass = TH1F("hst_h2_mass","ST H2 Mass Distribution", 20,0,800)
	...
	hst_hh_mass = TH1F("hst_hh_mass","ST HH Mass Distribution", 20,0,800)
        hst_hh_pt   = TH1F("hst_hh_pt","ST HH Pt Distribution", 20,0,600)
...
#	ff.Close()
	...
	stack_h2_mass.GetYaxis().SetTitle("Events/10GeV")
...
#	err_h2_mass.Draw("E2 same")
	...
	sel = hreal_h2_pt.GetMaximumBin()
        ...
        stack_h2_pt.GetYaxis().SetTitle("Events/10GeV")
...
#        err_h2_pt.Draw("E2 same")
	...
	sel = hreal_h2_eta.GetMaximumBin()
        ...
        stack_h2_eta.GetYaxis().SetTitle("Events/.12")
...
#        err_h2_eta.Draw("E2 same")
	...
	sel = hreal_h2_phi.GetMaximumBin()
        ...
        stack_h2_phi.GetYaxis().SetTitle("Events/.16rad")
