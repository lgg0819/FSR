...
with open("dataset_2017_el.json","r") as js:
        ...
        for key in jj.keys():
                ...
                for skey in subkey:
                        if len(flist) >= 2:
                                ...
                                with open("dataset_2017_el/%s%s.dat"%(key,skey),"wb") as output:
...
signal_filelist = pickle.load(open("dataset_2017_el/run2017B_el1aa.dat","rb"))
