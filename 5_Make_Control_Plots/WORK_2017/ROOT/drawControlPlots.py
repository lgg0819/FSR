...
def main():
	...
	hreal_j1_mass = TH1F("hreal_j1_mass","Real J1 Mass Distribution", 20,0,200)
        hreal_j1_pt   = TH1F("hreal_j1_pt","Real J1 Pt Distribution", 20,0,200)
        hreal_j1_eta  = TH1F("hreal_j1_eta","Real J1 Eta Distribution", 20,-2.4,2.4)
        hreal_j1_phi  = TH1F("hreal_j1_phi","Real J1 Phi Distribution", 20,-3.14,3.14)
        hreal_j1_btag = TH1F("hreal_j1_btag","Real J1 Btag Distribution", 20,0,1.01)

        hreal_j2_mass = TH1F("hreal_j2_mass","Real J2 Mass Distribution", 20,0,200)
        hreal_j2_pt   = TH1F("hreal_j2_pt","Real J2 Pt Distribution", 20,0,200)
        hreal_j2_eta  = TH1F("hreal_j2_eta","Real J2 Eta Distribution", 20,-2.4,2.4)
        hreal_j2_phi  = TH1F("hreal_j2_phi","Real J2 Phi Distribution", 20,-3.14,3.14)
        hreal_j2_btag = TH1F("hreal_j2_btag","Real J2 Btag Distribution", 20,0,1.01)

        hreal_l1_mass = TH1F("hreal_l1_mass","Real L1 Mass Distribution", 20,0,200)
        hreal_l1_pt   = TH1F("hreal_l1_pt","Real L1 Pt Distribution", 20,0,200)
        hreal_l1_eta  = TH1F("hreal_l1_eta","Real L1 Eta Distribution", 20,-2.4,2.4)
        hreal_l1_phi  = TH1F("hreal_l1_phi","Real L1 Phi Distribution", 20,-3.14,3.14)
        hreal_l1_charge = TH1F("hreal_l1_charge","Real L1 Charge Distribution", 20,0,1.01)

        hreal_l2_mass = TH1F("hreal_l2_mass","Real L2 Mass Distribution", 20,0,200)
        hreal_l2_pt   = TH1F("hreal_l2_pt","Real L2 Pt Distribution", 20,0,200)
        hreal_l2_eta  = TH1F("hreal_l2_eta","Real L2 Eta Distribution", 20,-2.4,2.4)
        hreal_l2_phi  = TH1F("hreal_l2_phi","Real L2 Phi Distribution", 20,-3.14,3.14)
        hreal_l2_charge = TH1F("hreal_l2_charge","Real L2 Charge Distribution", 20,0,1.01)

        hreal_dr_ll   = TH1F("hreal_dr_ll","Real DeltaR Between LL", 20,0,10)
        hreal_dr_jj   = TH1F("hreal_dr_jj","Real DeltaR Between JJ", 20,0,10)

        hreal_h1_mass = TH1F("hreal_h1_mass","Real H1 Mass Distribution", 20,0,400)
        hreal_h1_pt   = TH1F("hreal_h1_pt","Real H1 Pt Distribution", 20,0,400)
        hreal_h1_eta  = TH1F("hreal_h1_eta","Real H1 Eta Distribution", 20,-2.4,2.4)
        hreal_h1_phi  = TH1F("hreal_h1_phi","Real H1 Phi Distribution", 20,-3.14,3.14)

        hreal_h2_mass = TH1F("hreal_h2_mass","Real H2 Mass Distribution", 20,0,400)
        hreal_h2_pt   = TH1F("hreal_h2_pt","Real H2 Pt Distribution", 20,0,400)
        hreal_h2_eta  = TH1F("hreal_h2_eta","Real H2 Eta Distribution", 20,-2.4,2.4)
        hreal_h2_phi  = TH1F("hreal_h2_phi","Real H2 Phi Distribution", 20,-3.14,3.14)

        hreal_hh_mass = TH1F("hreal_hh_mass","Real HH Mass Distribution", 20,0,800)
        hreal_hh_pt   = TH1F("hreal_hh_pt","Real HH Pt Distribution", 20,0,800)
        hreal_hh_eta  = TH1F("hreal_hh_eta","Real HH Eta Distribution", 20,-2.4,2.4)
        hreal_hh_phi  = TH1F("hreal_hh_phi","Real HH Phi Distribution", 20,-3.14,3.14)


	hsig_j1_mass = TH1F("hsig_j1_mass","Signal J1 Mass Distribution", 20,0,200)
        hsig_j1_pt   = TH1F("hsig_j1_pt","Signal J1 Pt Distribution", 20,0,200)
        hsig_j1_eta  = TH1F("hsig_j1_eta","Signal J1 Eta Distribution", 20,-2.4,2.4)
        hsig_j1_phi  = TH1F("hsig_j1_phi","Signal J1 Phi Distribution", 20,-3.14,3.14)
        hsig_j1_btag = TH1F("hsig_j1_btag","Signal J1 Btag Distribution", 20,0,1.01)

        hsig_j2_mass = TH1F("hsig_j2_mass","Signal J2 Mass Distribution", 20,0,200)
        hsig_j2_pt   = TH1F("hsig_j2_pt","Signal J2 Pt Distribution", 20,0,200)
        hsig_j2_eta  = TH1F("hsig_j2_eta","Signal J2 Eta Distribution", 20,-2.4,2.4)
        hsig_j2_phi  = TH1F("hsig_j2_phi","Signal J2 Phi Distribution", 20,-3.14,3.14)
        hsig_j2_btag = TH1F("hsig_j2_btag","Signal J2 Btag Distribution", 20,0,1.01)

	hsig_l1_mass = TH1F("hsig_l1_mass","Signal L1 Mass Distribution", 20,0,200)
        hsig_l1_pt   = TH1F("hsig_l1_pt","Signal L1 Pt Distribution", 20,0,200)
        hsig_l1_eta  = TH1F("hsig_l1_eta","Signal L1 Eta Distribution", 20,-2.4,2.4)
        hsig_l1_phi  = TH1F("hsig_l1_phi","Signal L1 Phi Distribution", 20,-3.14,3.14)
        hsig_l1_charge = TH1F("hsig_l1_charge","Signal L1 Charge Distribution", 20,0,1.01)

        hsig_l2_mass = TH1F("hsig_l2_mass","Signal L2 Mass Distribution", 20,0,200)
        hsig_l2_pt   = TH1F("hsig_l2_pt","Signal L2 Pt Distribution", 20,0,200)
        hsig_l2_eta  = TH1F("hsig_l2_eta","Signal L2 Eta Distribution", 20,-2.4,2.4)
        hsig_l2_phi  = TH1F("hsig_l2_phi","Signal L2 Phi Distribution", 20,-3.14,3.14)
        hsig_l2_charge = TH1F("hsig_l2_charge","Signal L2 Charge Distribution", 20,0,1.01)

	hsig_dr_ll   = TH1F("hsig_dr_ll","Signal DeltaR Between LL", 20,0,10)
	hsig_dr_jj   = TH1F("hsig_dr_jj","Signal DeltaR Between JJ", 20,0,10)

	hsig_h1_mass = TH1F("hsig_h1_mass","Signal H1 Mass Distribution", 20,0,400)
	hsig_h1_pt   = TH1F("hsig_h1_pt","Signal H1 Pt Distribution", 20,0,400)
	hsig_h1_eta  = TH1F("hsig_h1_eta","Signal H1 Eta Distribution", 20,-2.4,2.4)
	hsig_h1_phi  = TH1F("hsig_h1_phi","Signal H1 Phi Distribution", 20,-3.14,3.14)

	hsig_h2_mass = TH1F("hsig_h2_mass","Signal H2 Mass Distribution", 20,0,400)
	hsig_h2_pt   = TH1F("hsig_h2_pt","Signal H2 Pt Distribution", 20,0,400)
	hsig_h2_eta  = TH1F("hsig_h2_eta","Signal H2 Eta Distribution", 20,-2.4,2.4)
	hsig_h2_phi  = TH1F("hsig_h2_phi","Signal H2 Phi Distribution", 20,-3.14,3.14)

	hsig_hh_mass = TH1F("hsig_hh_mass","Signal HH Mass Distribution", 20,0,800)
        hsig_hh_pt   = TH1F("hsig_hh_pt","Signal HH Pt Distribution", 20,0,800)
        hsig_hh_eta  = TH1F("hsig_hh_eta","Signal HH Eta Distribution", 20,-2.4,2.4)
        hsig_hh_phi  = TH1F("hsig_hh_phi","Signal HH Phi Distribution", 20,-3.14,3.14)


	htt_j1_mass = TH1F("htt_j1_mass","TTbar J1 Mass Distribution", 20,0,200)
        htt_j1_pt   = TH1F("htt_j1_pt","TTbar J1 Pt Distribution", 20,0,200)
        htt_j1_eta  = TH1F("htt_j1_eta","TTbar J1 Eta Distribution", 20,-2.4,2.4)
        htt_j1_phi  = TH1F("htt_j1_phi","TTbar J1 Phi Distribution", 20,-3.14,3.14)
        htt_j1_btag = TH1F("htt_j1_btag","TTbar J1 Btag Distribution", 20,0,1.01)

        htt_j2_mass = TH1F("htt_j2_mass","TTbar J2 Mass Distribution", 20,0,200)
        htt_j2_pt   = TH1F("htt_j2_pt","TTbar J2 Pt Distribution", 20,0,200)
        htt_j2_eta  = TH1F("htt_j2_eta","TTbar J2 Eta Distribution", 20,-2.4,2.4)
        htt_j2_phi  = TH1F("htt_j2_phi","TTbar J2 Phi Distribution", 20,-3.14,3.14)
        htt_j2_btag = TH1F("htt_j2_btag","TTbar J2 Btag Distribution", 20,0,1.01)

        htt_l1_mass = TH1F("htt_l1_mass","TTbar L1 Mass Distribution", 20,0,200)
        htt_l1_pt   = TH1F("htt_l1_pt","TTbar L1 Pt Distribution", 20,0,200)
        htt_l1_eta  = TH1F("htt_l1_eta","TTbar L1 Eta Distribution", 20,-2.4,2.4)
        htt_l1_phi  = TH1F("htt_l1_phi","TTbar L1 Phi Distribution", 20,-3.14,3.14)
        htt_l1_charge = TH1F("htt_l1_charge","TTbar L1 Charge Distribution", 20,-1,1.01)

        htt_l2_mass = TH1F("htt_l2_mass","TTbar L2 Mass Distribution", 20,0,200)
        htt_l2_pt   = TH1F("htt_l2_pt","TTbar L2 Pt Distribution", 20,0,200)
        htt_l2_eta  = TH1F("htt_l2_eta","TTbar L2 Eta Distribution", 20,-2.4,2.4)
        htt_l2_phi  = TH1F("htt_l2_phi","TTbar L2 Phi Distribution", 20,-3.14,3.14)
        htt_l2_charge = TH1F("htt_l2_charge","TTbar L2 Charge Distribution", 20,-1,1.01)

        htt_dr_ll   = TH1F("htt_dr_ll","TTbar DeltaR Between LL", 20,0,10)
        htt_dr_jj   = TH1F("htt_dr_jj","TTbar DeltaR Between JJ", 20,0,10)

	htt_h1_mass = TH1F("htt_h1_mass","TTbar H1 Mass Distribution", 20,0,400)
	htt_h1_pt   = TH1F("htt_h1_pt","TTbar H1 Pt Distribution", 20,0,400)
	htt_h1_eta  = TH1F("htt_h1_eta","TTbar H1 Eta Distribution", 20,-2.4,2.4)
	htt_h1_phi  = TH1F("htt_h1_phi","TTbar H1 Phi Distribution", 20,-3.14,3.14)

	htt_h2_mass = TH1F("htt_h2_mass","TTbar H2 Mass Distribution", 20,0,400)
	htt_h2_pt   = TH1F("htt_h2_pt","TTbar H2 Pt Distribution", 20,0,400)
	htt_h2_eta  = TH1F("htt_h2_eta","TTbar H2 Eta Distribution", 20,-2.4,2.4)
	htt_h2_phi  = TH1F("htt_h2_phi","TTbar H2 Phi Distribution", 20,-3.14,3.14)

	htt_hh_mass  = TH1F("htt_hh_mass","TTbar HH Mass Distribution", 20,0,800)
        htt_hh_pt    = TH1F("htt_hh_pt","TTbar HH Pt Distribution", 20,0,800)
        htt_hh_eta   = TH1F("htt_hh_eta","TTbar HH Eta Distribution", 20,-2.4,2.4)
        htt_hh_phi   = TH1F("htt_hh_phi","TTbar HH Phi Distribution", 20,-3.14,3.14)


	hdy_j1_mass = TH1F("hdy_j1_mass","DY J1 Mass Distribution", 20,0,200)
        hdy_j1_pt   = TH1F("hdy_j1_pt","DY J1 Pt Distribution", 20,0,200)
        hdy_j1_eta  = TH1F("hdy_j1_eta","DY J1 Eta Distribution", 20,-2.4,2.4)
        hdy_j1_phi  = TH1F("hdy_j1_phi","DY J1 Phi Distribution", 20,-3.14,3.14)
        hdy_j1_btag = TH1F("hdy_j1_btag","DY J1 Btag Distribution", 20,0,1.01)

        hdy_j2_mass = TH1F("hdy_j2_mass","DY J2 Mass Distribution", 20,0,200)
        hdy_j2_pt   = TH1F("hdy_j2_pt","DY J2 Pt Distribution", 20,0,200)
        hdy_j2_eta  = TH1F("hdy_j2_eta","DY J2 Eta Distribution", 20,-2.4,2.4)
        hdy_j2_phi  = TH1F("hdy_j2_phi","DY J2 Phi Distribution", 20,-3.14,3.14)
        hdy_j2_btag = TH1F("hdy_j2_btag","DY J2 Btag Distribution", 20,0,1.01)

        hdy_l1_mass = TH1F("hdy_l1_mass","DY L1 Mass Distribution", 20,0,200)
        hdy_l1_pt   = TH1F("hdy_l1_pt","DY L1 Pt Distribution", 20,0,200)
        hdy_l1_eta  = TH1F("hdy_l1_eta","DY L1 Eta Distribution", 20,-2.4,2.4)
        hdy_l1_phi  = TH1F("hdy_l1_phi","DY L1 Phi Distribution", 20,-3.14,3.14)
        hdy_l1_charge = TH1F("hdy_l1_charge","DY L1 Charge Distribution", 20,-1,1.01)

        hdy_l2_mass = TH1F("hdy_l2_mass","DY L2 Mass Distribution", 20,0,200)
        hdy_l2_pt   = TH1F("hdy_l2_pt","DY L2 Pt Distribution", 20,0,200)
        hdy_l2_eta  = TH1F("hdy_l2_eta","DY L2 Eta Distribution", 20,-2.4,2.4)
        hdy_l2_phi  = TH1F("hdy_l2_phi","DY L2 Phi Distribution", 20,-3.14,3.14)
        hdy_l2_charge = TH1F("hdy_l2_charge","DY L2 Charge Distribution", 20,-1,1.01)

        hdy_dr_ll   = TH1F("hdy_dr_ll","DY DeltaR Between LL", 20,0,10)
        hdy_dr_jj   = TH1F("hdy_dr_jj","DY DeltaR Between JJ", 20,0,10)

	hdy_h1_mass = TH1F("hdy_h1_mass","DY H1 Mass Distribution", 20,0,400)
	hdy_h1_pt   = TH1F("hdy_h1_pt","DY H1 Pt Distribution", 20,0,400)
	hdy_h1_eta  = TH1F("hdy_h1_eta","DY H1 Eta Distribution", 20,-2.4,2.4)
	hdy_h1_phi  = TH1F("hdy_h1_phi","DY H1 Phi Distribution", 20,-3.14,3.14)

	hdy_h2_mass = TH1F("hdy_h2_mass","DY H2 Mass Distribution", 20,0,400)
	hdy_h2_pt   = TH1F("hdy_h2_pt","DY H2 Pt Distribution", 20,0,400)
	hdy_h2_eta  = TH1F("hdy_h2_eta","DY H2 Eta Distribution", 20,-2.4,2.4)
	hdy_h2_phi  = TH1F("hdy_h2_phi","DY H2 Phi Distribution", 20,-3.14,3.14)

	hdy_hh_mass  = TH1F("hdy_hh_mass","DY HH Mass Distribution", 20,0,800)
	hdy_hh_pt    = TH1F("hdy_hh_pt","DY HH Pt Distribution", 20,0,800)
	hdy_hh_eta   = TH1F("hdy_hh_eta","DY HH Eta Distribution", 20,-2.4,2.4)
	hdy_hh_phi   = TH1F("hdy_hh_phi","DY HH Phi Distribution", 20,-3.14,3.14)


	hwj_j1_mass = TH1F("hwj_j1_mass","WJ J1 Mass Distribution", 20,0,200)
        hwj_j1_pt   = TH1F("hwj_j1_pt","WJ J1 Pt Distribution", 20,0,200)
        hwj_j1_eta  = TH1F("hwj_j1_eta","WJ J1 Eta Distribution", 20,-2.4,2.4)
        hwj_j1_phi  = TH1F("hwj_j1_phi","WJ J1 Phi Distribution", 20,-3.14,3.14)
        hwj_j1_btag = TH1F("hwj_j1_btag","WJ J1 Btag Distribution", 20,0,1.01)

        hwj_j2_mass = TH1F("hwj_j2_mass","WJ J2 Mass Distribution", 20,0,200)
        hwj_j2_pt   = TH1F("hwj_j2_pt","WJ J2 Pt Distribution", 20,0,200)
        hwj_j2_eta  = TH1F("hwj_j2_eta","WJ J2 Eta Distribution", 20,-2.4,2.4)
        hwj_j2_phi  = TH1F("hwj_j2_phi","WJ J2 Phi Distribution", 20,-3.14,3.14)
        hwj_j2_btag = TH1F("hwj_j2_btag","WJ J2 Btag Distribution", 20,0,1.01)

        hwj_l1_mass = TH1F("hwj_l1_mass","WJ L1 Mass Distribution", 20,0,200)
        hwj_l1_pt   = TH1F("hwj_l1_pt","WJ L1 Pt Distribution", 20,0,200)
        hwj_l1_eta  = TH1F("hwj_l1_eta","WJ L1 Eta Distribution", 20,-2.4,2.4)
        hwj_l1_phi  = TH1F("hwj_l1_phi","WJ L1 Phi Distribution", 20,-3.14,3.14)
        hwj_l1_charge = TH1F("hwj_l1_charge","WJ L1 Charge Distribution", 20,-1,1.01)

        hwj_l2_mass = TH1F("hwj_l2_mass","WJ L2 Mass Distribution", 20,0,200)
        hwj_l2_pt   = TH1F("hwj_l2_pt","WJ L2 Pt Distribution", 20,0,200)
        hwj_l2_eta  = TH1F("hwj_l2_eta","WJ L2 Eta Distribution", 20,-2.4,2.4)
        hwj_l2_phi  = TH1F("hwj_l2_phi","WJ L2 Phi Distribution", 20,-3.14,3.14)
        hwj_l2_charge = TH1F("hwj_l2_charge","WJ L2 Charge Distribution", 20,-1,1.01)

        hwj_dr_ll   = TH1F("hwj_dr_ll","WJ DeltaR Between LL", 20,0,10)
        hwj_dr_jj   = TH1F("hwj_dr_jj","WJ DeltaR Between JJ", 20,0,10)

        hwj_h1_mass = TH1F("hwj_h1_mass","WJ H1 Mass Distribution", 20,0,400)
        hwj_h1_pt   = TH1F("hwj_h1_pt","WJ H1 Pt Distribution", 20,0,400)
        hwj_h1_eta  = TH1F("hwj_h1_eta","WJ H1 Eta Distribution", 20,-2.4,2.4)
        hwj_h1_phi  = TH1F("hwj_h1_phi","WJ H1 Phi Distribution", 20,-3.14,3.14)

        hwj_h2_mass = TH1F("hwj_h2_mass","WJ H2 Mass Distribution", 20,0,400)
        hwj_h2_pt   = TH1F("hwj_h2_pt","WJ H2 Pt Distribution", 20,0,400)
        hwj_h2_eta  = TH1F("hwj_h2_eta","WJ H2 Eta Distribution", 20,-2.4,2.4)
        hwj_h2_phi  = TH1F("hwj_h2_phi","WJ H2 Phi Distribution", 20,-3.14,3.14)

        hwj_hh_mass = TH1F("hwj_hh_mass","WJ HH Mass Distribution", 20,0,800)
        hwj_hh_pt   = TH1F("hwj_hh_pt","WJ HH Pt Distribution", 20,0,800)
        hwj_hh_eta  = TH1F("hwj_hh_eta","WJ HH Eta Distribution", 20,-2.4,2.4)
        hwj_hh_phi  = TH1F("hwj_hh_phi","WJ HH Phi Distribution", 20,-3.14,3.14)


	hst_j1_mass = TH1F("hst_j1_mass","ST J1 Mass Distribution", 20,0,200)
        hst_j1_pt   = TH1F("hst_j1_pt","ST J1 Pt Distribution", 20,0,200)
        hst_j1_eta  = TH1F("hst_j1_eta","ST J1 Eta Distribution", 20,-2.4,2.4)
        hst_j1_phi  = TH1F("hst_j1_phi","ST J1 Phi Distribution", 20,-3.14,3.14)
        hst_j1_btag = TH1F("hst_j1_btag","ST J1 Btag Distribution", 20,0,1.01)

        hst_j2_mass = TH1F("hst_j2_mass","ST J2 Mass Distribution", 20,0,200)
        hst_j2_pt   = TH1F("hst_j2_pt","ST J2 Pt Distribution", 20,0,200)
        hst_j2_eta  = TH1F("hst_j2_eta","ST J2 Eta Distribution", 20,-2.4,2.4)
        hst_j2_phi  = TH1F("hst_j2_phi","ST J2 Phi Distribution", 20,-3.14,3.14)
        hst_j2_btag = TH1F("hst_j2_btag","ST J2 Btag Distribution", 20,0,1.01)

        hst_l1_mass = TH1F("hst_l1_mass","ST L1 Mass Distribution", 20,0,200)
        hst_l1_pt   = TH1F("hst_l1_pt","ST L1 Pt Distribution", 20,0,200)
        hst_l1_eta  = TH1F("hst_l1_eta","ST L1 Eta Distribution", 20,-2.4,2.4)
        hst_l1_phi  = TH1F("hst_l1_phi","ST L1 Phi Distribution", 20,-3.14,3.14)
        hst_l1_charge = TH1F("hst_l1_charge","ST L1 Charge Distribution", 20,-1,1.01)

        hst_l2_mass = TH1F("hst_l2_mass","ST L2 Mass Distribution", 20,0,200)
        hst_l2_pt   = TH1F("hst_l2_pt","ST L2 Pt Distribution", 20,0,200)
        hst_l2_eta  = TH1F("hst_l2_eta","ST L2 Eta Distribution", 20,-2.4,2.4)
        hst_l2_phi  = TH1F("hst_l2_phi","ST L2 Phi Distribution", 20,-3.14,3.14)
        hst_l2_charge = TH1F("hst_l2_charge","ST L2 Charge Distribution", 20,-1,1.01)

        hst_dr_ll   = TH1F("hst_dr_ll","ST DeltaR Between LL", 20,0,10)
        hst_dr_jj   = TH1F("hst_dr_jj","ST DeltaR Between JJ", 20,0,10)

	hst_h1_mass = TH1F("hst_h1_mass","ST H1 Mass Distribution", 20,0,400)
	hst_h1_pt   = TH1F("hst_h1_pt","ST H1 Pt Distribution", 20,0,400)
	hst_h1_eta  = TH1F("hst_h1_eta","ST H1 Eta Distribution", 20,-2.4,2.4)
	hst_h1_phi  = TH1F("hst_h1_phi","ST H1 Phi Distribution", 20,-3.14,3.14)

	hst_h2_mass = TH1F("hst_h2_mass","ST H2 Mass Distribution", 20,0,400)
        hst_h2_pt   = TH1F("hst_h2_pt","ST H2 Pt Distribution", 20,0,400)
        hst_h2_eta  = TH1F("hst_h2_eta","ST H2 Eta Distribution", 20,-2.4,2.4)
        hst_h2_phi  = TH1F("hst_h2_phi","ST H2 Phi Distribution", 20,-3.14,3.14)

	hst_hh_mass = TH1F("hst_hh_mass","ST HH Mass Distribution", 20,0,800)
        hst_hh_pt   = TH1F("hst_hh_pt","ST HH Pt Distribution", 20,0,800)
        hst_hh_eta  = TH1F("hst_hh_eta","ST HH Eta Distribution", 20,-2.4,2.4)
        hst_hh_phi  = TH1F("hst_hh_phi","ST HH Phi Distribution", 20,-3.14,3.14)
	...
	stack_j1_mass = THStack("stack_j1_mass","Stacked Mass Distribution J1")
        ...
        stack_h1_mass = THStack("stack_h1_mass","Stacked Mass Distribution H1<-WW")
        stack_h1_pt   = THStack("stack_h1_pt","Stacked Pt Distribution H1<-WW")
        stack_h1_eta  = THStack("stack_h1_eta","Stacked Eta Distribution H1<-WW")
        stack_h1_phi  = THStack("stack_h1_phi","Stacked Phi Distribution H1<-WW")
	...
	for fname in flist:
		...
		# Real
			...
			if (dr == 'run2017B' or dr == 'run2017C' or dr == 'run2017D' or dr == 'run2017E' or dr == 'run2017F' or dr == 'run2017G' or dr == 'run2017H'):
		...
		rh1_yield = np.sum(real_h1_mass)
		rh2_yield = np.sum(real_h2_mass)
		rhh_yield = np.sum(real_hh_mass)
		...
		# TT
		sf_tt_2l2nu = corr*88.4/4891620336.1
		sf_tt_semi  = corr*366/32366940321.3
		sf_tt_had   = corr*378/21432310862.9
		...
		# DY
		sf_dy_m50 = corr*6080/1.89714162185e+12
		sf_dy_0j  = corr*4840/2.83853150541e+11
		sf_dy_1j  = corr*898/2.24631958677e+11
		sf_dy_2j  = corr*336/1.02265928169e+11
		...
		# WJ
		sf_wj_jets= corr*61500/86916455.0
		sf_wj_1j  = corr*9440/45283121.0
		sf_wj_2j  = corr*3250/60438768.0
		sf_wj_3j  = corr*1150/59228199.0
		sf_wj_4j  = corr*634/27868119.0
		...
		# ST
                sf_st_schannel_incl = corr*3.36/3370668.5
		sf_st_tchannel_top  = corr*136/58403420.0
		sf_st_tchannel_anti = corr*81/38811017.0
                sf_st_tW_top  = corr*35.8/6952830.0
                sf_st_tW_anti = corr*35.8/6933094.0

                if (dr == 'st_schannel_incl' or dr == "st_tchannel_top" or dr == "st_tchannel_anti" or dr == "st_tW_top" or dr == "st_tW_anti"):
	...
	err_j1_mass = TH1F("err_j1_mass","Error J1 Mass Distribution", 20,0,200)
        err_j1_pt   = TH1F("err_j1_pt","Error J1 Pt Distribution", 20,0,400)
        err_j1_eta  = TH1F("err_j1_eta","Error J1 Eta Distribution", 20,-2.4,2.4)
        err_j1_phi  = TH1F("err_j1_phi","Error J1 Phi Distribution", 20,-3.14,3.14)
        err_j1_btag = TH1F("err_j1_btag","Error J1 Btag Distribution", 20,0,1.01)

        err_j2_mass = TH1F("err_j2_mass","Error J2 Mass Distribution", 20,0,200)
        err_j2_pt   = TH1F("err_j2_pt","Error J2 Pt Distribution", 20,0,400)
        err_j2_eta  = TH1F("err_j2_eta","Error J2 Eta Distribution", 20,-2.4,2.4)
        err_j2_phi  = TH1F("err_j2_phi","Error J2 Phi Distribution", 20,-3.14,3.14)
        err_j2_btag = TH1F("err_j2_btag","Error J2 Btag Distribution", 20,0,1.01)

        err_l1_mass = TH1F("err_l1_mass","Error L1 Mass Distribution", 20,0,200)
        err_l1_pt   = TH1F("err_l1_pt","Error L1 Pt Distribution", 20,0,400)
        err_l1_eta  = TH1F("err_l1_eta","Error L1 Eta Distribution", 20,-2.4,2.4)
        err_l1_phi  = TH1F("err_l1_phi","Error L1 Phi Distribution", 20,-3.14,3.14)
        err_l1_charge = TH1F("err_l1_charge","Error L1 Charge Distribution", 20,-1,1.01)

        err_l2_mass = TH1F("err_l2_mass","Error L2 Mass Distribution", 20,0,200)
        err_l2_pt   = TH1F("err_l2_pt","Error L2 Pt Distribution", 20,0,400)
        err_l2_eta  = TH1F("err_l2_eta","Error L2 Eta Distribution", 20,-2.4,2.4)
        err_l2_phi  = TH1F("err_l2_phi","Error L2 Phi Distribution", 20,-3.14,3.14)
        err_l2_charge = TH1F("err_l2_charge","Error L2 Charge Distribution", 20,-1,1.01)

        err_dr_ll   = TH1F("err_dr_ll","Error DeltaR Between LL", 20,0,10)
        err_dr_jj   = TH1F("err_dr_jj","Error DeltaR Between JJ", 20,0,10)

        err_h1_mass = TH1F("err_h1_mass","Error H1 Mass Distribution", 20,0,800)
        err_h1_pt   = TH1F("err_h1_pt","Error H1 Pt Distribution", 20,0,400)
        err_h1_eta  = TH1F("err_h1_eta","Error H1 Eta Distribution", 20,-2.4,2.4)
        err_h1_phi  = TH1F("err_h1_phi","Error H1 Phi Distribution", 20,-3.14,3.14)

        err_h2_mass = TH1F("err_h2_mass","Error H2 Mass Distribution", 20,0,800)
        err_h2_pt   = TH1F("err_h2_pt","Error H2 Pt Distribution", 20,0,400)
        err_h2_eta  = TH1F("err_h2_eta","Error H2 Eta Distribution", 20,-2.4,2.4)
        err_h2_phi  = TH1F("err_h2_phi","Error H2 Phi Distribution", 20,-3.14,3.14)

        err_hh_mass = TH1F("err_hh_mass","Error HH Mass Distribution", 20,0,800)
        err_hh_pt   = TH1F("err_hh_pt","Error HH Pt Distribution", 20,0,600)
        err_hh_eta  = TH1F("err_hh_eta","Error HH Eta Distribution", 20,-2.4,2.4)
        err_hh_phi  = TH1F("err_hh_phi","Error HH Phi Distribution", 20,-3.14,3.14)
	...
	for i in range(1,err_j1_mass.GetNbinsX()+1):
		...
		err_j1_mass.SetBinError(i,err_j1_mass.GetBinContent(i)**.5)
		err_j1_pt.SetBinError(i,err_j1_pt.GetBinContent(i)**.5)
		err_j1_eta.SetBinError(i,err_j1_eta.GetBinContent(i)**.5)
		err_j1_phi.SetBinError(i,err_j1_phi.GetBinContent(i)**.5)
		err_j1_btag.SetBinError(i,err_j1_btag.GetBinContent(i)**.5)

		err_j2_mass.SetBinError(i,err_j2_mass.GetBinContent(i)**.5)
                err_j2_pt.SetBinError(i,err_j2_pt.GetBinContent(i)**.5)
                err_j2_eta.SetBinError(i,err_j2_eta.GetBinContent(i)**.5)
                err_j2_phi.SetBinError(i,err_j2_phi.GetBinContent(i)**.5)
                err_j2_btag.SetBinError(i,err_j2_btag.GetBinContent(i)**.5)

		err_l1_mass.SetBinError(i,err_l1_mass.GetBinContent(i)**.5)
                err_l1_pt.SetBinError(i,err_l1_pt.GetBinContent(i)**.5)
                err_l1_eta.SetBinError(i,err_l1_eta.GetBinContent(i)**.5)
                err_l1_phi.SetBinError(i,err_l1_phi.GetBinContent(i)**.5)
                err_l1_charge.SetBinError(i,err_l1_charge.GetBinContent(i)**.5)

                err_l2_mass.SetBinError(i,err_l2_mass.GetBinContent(i)**.5)
                err_l2_pt.SetBinError(i,err_l2_pt.GetBinContent(i)**.5)
                err_l2_eta.SetBinError(i,err_l2_eta.GetBinContent(i)**.5)
                err_l2_phi.SetBinError(i,err_l2_phi.GetBinContent(i)**.5)
                err_l2_charge.SetBinError(i,err_l2_charge.GetBinContent(i)**.5)

		err_dr_ll.SetBinError(i,err_dr_ll.GetBinContent(i)**.5)
		err_dr_jj.SetBinError(i,err_dr_jj.GetBinContent(i)**.5)

		err_h1_mass.SetBinError(i,err_h1_mass.GetBinContent(i)**.5)
                err_h1_pt.SetBinError(i,err_h1_pt.GetBinContent(i)**.5**.5)
                err_h1_eta.SetBinError(i,err_h1_eta.GetBinContent(i)**.5**.5)
                err_h1_phi.SetBinError(i,err_h1_phi.GetBinContent(i)**.5**.5)

		err_h2_mass.SetBinError(i,err_h2_mass.GetBinContent(i)**.5)
                err_h2_pt.SetBinError(i,err_h2_pt.GetBinContent(i)**.5**.5)
                err_h2_eta.SetBinError(i,err_h2_eta.GetBinContent(i)**.5**.5)
                err_h2_phi.SetBinError(i,err_h2_phi.GetBinContent(i)**.5**.5)

		err_hh_mass.SetBinError(i,err_hh_mass.GetBinContent(i)**.5)
                err_hh_pt.SetBinError(i,err_hh_pt.GetBinContent(i)**.5**.5)
                err_hh_eta.SetBinError(i,err_hh_eta.GetBinContent(i)**.5**.5)
                err_hh_phi.SetBinError(i,err_hh_phi.GetBinContent(i)**.5**.5)
...
#	ff.Close()
	...
	c1 = TCanvas("c1","Stacked Histograms of Basic Kinematics h2", 900,600)

	c1.Divide(2,2)
        c1.cd(1)
	stack_h2_mass.Draw("hist")
	sel = hreal_h2_mass.GetMaximumBin()
        ylim = hreal_h2_mass.GetBinCenter(sel)
        stack_h2_mass.GetYaxis().SetRangeUser(0,ylim+1000)
	stack_h2_mass.GetXaxis().SetTitle("Invariant Mass[GeV]")
	stack_h2_mass.GetYaxis().SetTitle("Events/20GeV")
	hsig_h2_mass.SetLineColor(kRed)
	hsig_h2_mass.Draw("hist same")
	hreal_h2_mass.SetLineColor(kBlack)
        hreal_h2_mass.Draw("hist e1 same")
#	err_h2_mass.SetFillColor(kBlue)
#	err_h2_mass.SetFillStyle(3004)
#	err_h2_mass.Draw("E2 same")
	lst_h2_mass.Draw()

	c1.cd(2)
	stack_h2_pt.Draw("hist")
	sel = hreal_h2_pt.GetMaximumBin()
        ylim = hreal_h2_pt.GetBinCenter(sel)
        stack_h2_pt.GetYaxis().SetRangeUser(0,ylim+1000)
        stack_h2_pt.GetXaxis().SetTitle("Transverse Momentum[GeV]")
        stack_h2_pt.GetYaxis().SetTitle("Events/20GeV")
        hsig_h2_pt.SetLineColor(kRed)
        hsig_h2_pt.Draw("hist same")
	hreal_h2_pt.SetLineColor(kBlack)
        hreal_h2_pt.Draw("hist e1 same")
#        err_h2_pt.SetFillColor(kBlue)
#        err_h2_pt.SetFillStyle(3004)
#        err_h2_pt.Draw("E2 same")
        lst_h2_pt.Draw()

	c1.cd(3)
	stack_h2_eta.Draw("hist")
	sel = hreal_h2_eta.GetMaximumBin()
        ylim = hreal_h2_eta.GetBinCenter(sel)
        stack_h2_eta.GetYaxis().SetRangeUser(0,ylim+1000)
        stack_h2_eta.GetXaxis().SetTitle("Eta")
        stack_h2_eta.GetYaxis().SetTitle("Events/.24")
        hsig_h2_eta.SetLineColor(kRed)
        hsig_h2_eta.Draw("hist same")
	hreal_h2_eta.SetLineColor(kBlack)
        hreal_h2_eta.Draw("hist e1 same")
#        err_h2_eta.SetFillColor(kBlue)
#        err_h2_eta.SetFillStyle(3004)
#        err_h2_eta.Draw("E2 same")
        lst_h2_eta.Draw()

	c1.cd(4)
	stack_h2_phi.Draw("hist")
	sel = hreal_h2_phi.GetMaximumBin()
        ylim = hreal_h2_phi.GetBinCenter(sel)
        stack_h2_phi.GetYaxis().SetRangeUser(0,ylim+1000)
        stack_h2_phi.GetXaxis().SetTitle("Phi")
        stack_h2_phi.GetYaxis().SetTitle("Events/.32rad")
        hsig_h2_phi.SetLineColor(kRed)
        hsig_h2_phi.Draw("hist same")
	hreal_h2_phi.SetLineColor(kBlack)
        hreal_h2_phi.Draw("hist e1 same")
#        err_h2_phi.SetFillColor(kBlue)
#        err_h2_phi.SetFillStyle(3004)
#        err_h2_phi.Draw("E2 same")
        lst_h2_phi.Draw()
