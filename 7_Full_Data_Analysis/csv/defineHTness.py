...
#        flist = glob.glob('/xrootd/store/mc/RunIISummer16NanoAODv7/TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8/NANOAODSIM/PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8-v1/*/*')
	...
	for i in range(len(jet1_mass)):
		...
		def defineTopness(x):
			...
			t = [t1_p4.M(),t2_p4.M(),t3_p4.M(),t4_p4.M()]
			w = [w1_p4.M(),w2_p4.M()]

			sig_t = 48.1
			sig_w = 21.4

			chi2.append( ((t[0]**2-t_mass**2)**2/sig_t**4) + ((w[0]**2-w_mass**2)**2/sig_w**4) + ((t[3]**2-t_mass**2)**2/sig_t**4) + ((w[1]**2-w_mass**2)**2/sig_w**4) )
			chi2.append( ((t[1]**2-t_mass**2)**2/sig_t**4) + ((w[0]**2-w_mass**2)**2/sig_w**4) + ((t[2]**2-t_mass**2)**2/sig_t**4) + ((w[1]**2-w_mass**2)**2/sig_w**4) )
