...
def defineHTness():
	...
	bkg = pd.read_csv('/cms/ldap_home/chdlalsnr/HH/CMSSW_11_0_0/src/HHAnalysis/HH/python/7_Full_Data_Analysis/csv/background.csv')
	...
	for i in range(len(jet1_mass)):
        ...
        df.to_csv("htness_bkg.csv", header=True, index=False)
